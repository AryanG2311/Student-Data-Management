...
import { RefreshCw, Save, Download, FileText } from 'lucide-react';
    ...
    <div className="rounded-md border border-slate-200 bg-white p-5 shadow-sm space-y-5">
      ...
      <div className="flex flex-wrap items-center gap-2.5 border-t border-slate-100 pt-4">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-md border border-red-200 bg-red-50 hover:bg-red-100 px-4 py-2 text-sm font-semibold text-red-700 shadow-sm transition duration-150 focus:outline-none cursor-pointer sm:ml-auto"
        >
          Clear Session
        </button>
      </div>
